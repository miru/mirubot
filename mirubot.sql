...
insert into reply_word_list values(1, 1,  ' うんうん');
insert into reply_word_list values(1, 2,  ' もっふもふにしてやんよー');
insert into reply_word_list values(1, 2,  ' もふもふは幸せですね ＞ω＜');
insert into reply_word_list values(1, 3, ' さんがちゅっちゅしてるー');
insert into reply_word_list values(1, 3,  ' ちゅっちゅっちゅ♪');
insert into reply_word_list values(1, 4, ' ヾ(＞ω＜ ) なでなでー');
insert into reply_word_list values(1, 4, ' ヾ(＞ω＜ ) よしよし');
insert into reply_word_list values(1, 5,  ' ぎゅーっとぎゅっと');
insert into reply_word_list values(1, 5,  ' ぎゅっとぎゅっとー');
insert into reply_word_list values(1, 6,  ' ｣(･ ω ･｣) ｶﾞｯ');
insert into reply_word_list values(1, 6,  ' ヽ( ・∀・)ﾉ┌┛ガッ');
insert into reply_word_list values(1, 6,  ' ■━⊂(　・∀・) 彡 ガッ');
